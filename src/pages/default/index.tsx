  ...
  return (
    <div>
        ...
        <div className="rounded-[12px] bg-[#fee6fc] dark:bg-[#525459] text-[#222638] dark:text-[#9EA3B5] p-[22px] w-[560px]">
          <div className="flex mb-[20px]">
            ...
            <p className="text-[18px] font-[500] ml-[20px] mt-[-5px] w-[250px]">
              {t("About login and password in the teacher panel")}
            </p>
          </div>
          <p className="text-[16px] font-[500] mb-[20px]">
            {t(
              "Never tell anyone your login and password for your teacher panel!"
            )}
          </p>
      ...
      <div className="bottom-part mt-[32px] flex justify-between items-center">
        <div className="left-part w-[500px] text-[18px] dark:text-[#f9acec]">
