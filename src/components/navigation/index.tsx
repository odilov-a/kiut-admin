...
const Navigation: React.FC = () => {
  ...
  return (
    <Menu
      ...
      className="h-full w-[280px] dark:bg-[#0096db]"
      style={{ transition: "none" }}
    >
      <div className="flex items-center justify-center text-center text-[20px] font-[500] mt-[30px] mb-[25px] cursor-pointer dark:text-[#0096db]">
        {/* <img
          src={logo}
          alt="Logo"
          ...
          {menuItem.children ? (
            ...
            >
              {menuItem.children.map((childItem) => (
                <Menu.Item
                  key={childItem.key}
                  className="left-sidebar text-[#0096db] text-[17px]"
                >
                  {childItem.route ? (
                    // @ts-ignore
